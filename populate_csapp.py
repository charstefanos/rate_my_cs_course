...
def populate():
    ...
    year1_ratings = [
        {'student':'Arthur',
         'course':'1CT INTRODUCTION TO COMPUTATIONAL THINKING COMPSCI1016',
         'overallRating':4,
         'lecturerRating':3,
         'engagement':4,
         'informative':4,
        ...
        {'student':'Arthur',
         'course':'1F - COMPUTING FUNDAMENTALS COMPSCI1006',
         'overallRating':4,
         'lecturerRating':4,
         'engagement':3,
         'informative':4,
         'comment':'Great!'},
        {'student':'Arthur',
         'course':'COMPUTING SCIENCE 1PX (ALTERNATE ROUTE) COMPSCI1017',
         'overallRating':2,
         'lecturerRating':3,
         'engagement':2,
         'informative':3,
         'comment':"Didn't really enjoy it"},
         {'student':'SamJ',
         'course':'1S SYSTEMS COMPSCI1018',
         'overallRating':5,
         'lecturerRating':5,
        ...
        {'student':'Melvin',
         ...
         'engagement':3,
         'informative':4,
         'comment':"Great course with an amazing lecturer"},
        {'student':'Melvin',
         'course':'1F - COMPUTING FUNDAMENTALS COMPSCI1006',
         'overallRating':3,
         'lecturerRating':3,
         ...
         'comment':"Just ok"},
        {'student':'Melvin',
         'course':'TESTING AND SOFTWARE IMPROVEMENT COMPSCI1022',
         'overallRating':2,
         'lecturerRating':3,
         'engagement':3,
         'informative':3,
         'comment':"Didn't really enjoy it"},
        {'student':'Melvin',
         'course':'COMPUTING SCIENCE 1P (STANDARD ROUTE) COMPSCI1001',
         'overallRating':4,
         'lecturerRating':2,
         'engagement':4,
         'informative':4,
         'comment':"Good course, lecturers could be better"},
        {'student':'James',
         'course':'1CT INTRODUCTION TO COMPUTATIONAL THINKING COMPSCI1016',
         'overallRating':5,
         'lecturerRating':5,
        ...
        {'student':'James',
         ...
         'engagement':4,
         'informative':3,
         'comment':"Great course, information could be a bit clearer"},
        {'student':'James',
         'course':'1F - COMPUTING FUNDAMENTALS COMPSCI1006',
         'overallRating':3,
         'lecturerRating':3,
        ...
        {'student':'James',
         ...
         'engagement':3,
         'informative':4,
         'comment':"Ok but could be better"},
        {'student':'Mary',
         'course':'1S SYSTEMS COMPSCI1018',
         'overallRating':5,
         'lecturerRating':4,
         'engagement':4,
         'informative':4,
         'comment':"Great, really enjoyed it"},
        {'student':'Mary',
         'course':'1F - COMPUTING FUNDAMENTALS COMPSCI1006',
         'overallRating':4,
         'lecturerRating':3,
         ...
         'comment':"Great course"},
        {'student':'Mary',
         'course':'COMPUTING SCIENCE 1P (HALF COURSE) COMPSCI1005',
         'overallRating':2,
         'lecturerRating':1,
         'engagement':2,
         'informative':2,
         'comment':"Did not really enjoy it"},
        {'student':'Mary',
         'course':'PRACTICAL ALGORITHMS COMPSCI1021',
         'overallRating':3,
         'lecturerRating':4,
         'engagement':4,
         'informative':2,
        ...
        {'student':'Bret',
         'course':'HOW TO LEARN A NEW LANGUAGE COMPSCI1020',
         'overallRating':4,
         'lecturerRating':3,
         'engagement':3,
         'informative':4,
         'comment':"Would really recommend it"},
        {'student':'Bret',
         'course':'WEB APPLICATION SYSTEMS COMPSCI1023',
         'overallRating':3,
         'lecturerRating':4,
         'engagement':3,
         'informative':4,
    ...
    year2_ratings = [
        {'student':'Ada',
         'course':'ALGORITHMS & DATA STRUCTURES 2 COMPSCI2007',
         'overallRating':4,
         'lecturerRating':4,
         'engagement':4,
         'informative':4,
         'comment':"Great course with an amazing lecturer"},
        {'student':'Ada',
         'course':'ALGORITHMIC FOUNDATIONS 2 COMPSCI2003',
         'overallRating':2,
         'lecturerRating':3,
         'engagement':3,
         'informative':3,
         'comment':"Didn't really enjoy it"},
        {'student':'Ada',
         'course': 'JAVA PROGRAMMING 2 COMPSCI2001',
         'overallRating':5,
         'lecturerRating':5,
         'engagement':5,
         'informative':5,
        ...
        {'student':'Ada',
         'course': 'NETWORKS AND OPERATING SYSTEMS ESSENTIALS 2 COMPSCI2024',
         'overallRating':3,
         'lecturerRating':4,
         'engagement':3,
         'informative':3,
        ...
        {'student':'Ada',
         'course': 'OBJECT-ORIENTED SOFTWARE ENGINEERING 2 COMPSCI2008',
         'overallRating':3,
         'lecturerRating':4,
         'engagement':3,
         'informative':4,
         'comment':"Ok but could be better"},
        {'student':'Ada',
         'course': 'WEB APPLICATION DEVELOPMENT 2 COMPSCI2021',
         'overallRating':4,
         'lecturerRating':4,
         'engagement':4,
         'informative':4,
    ...
    example_ratings = [year1_ratings, year2_ratings]
    ...
    # The code below goes through the example_users list, then for each sublist, creates the users and user profiles.
    ...
    # The code below goes through the example_ratings list, then for each sublist, creates the reviews .
    for category in example_ratings:
        for rating in category:
            add_rating(rating['student'], rating['course'], rating['overallRating'], rating['lecturerRating'], rating['engagement'], rating['informative'], rating['comment'])
...
def add_rating(student, course, overallRating, lecturerRating, engagement, informative, comment):
    studentUser = User.objects.get(username = student)
    studentProfile = UserProfile.objects.get(user = studentUser)
    courseObject = Course.objects.get(name = course)
    
    rating = CourseRating.objects.get_or_create(student = studentProfile, course = courseObject,
                                                defaults={'overall_rating': overallRating,
